...
TotalPrice:number;
  ...
  FillProductsfrmApi():Observable<IProduct[]>{
    const httpOptions =  new HttpHeaders({
     ...
     this.Products=this.h.get<IProduct[]>(`${environment.DataURl2}/product`);
   ...
   GetProductByID(ProductID):Observable<IProduct>{
    const httpOptions =  new HttpHeaders({
     ...
     return this.h.get<IProduct>(`${environment.DataURl2}/product/${ProductID}`);
   ...
   Add(Prd:IProduct ,PrdImage:File):Observable<IProduct>{
    ...
    const httpOptions =  new HttpHeaders({
     ...
     return this.h.post<IProduct>(`${environment.DataURl2}/product`,Prdfd)
    ...
    update(Prd:IProduct,PrdImage:File):Observable<IProduct>
    {
      const httpOptions =  new HttpHeaders({
       ...
       return this.h.put<IProduct>(`${environment.DataURl2}/product`,Prdfd)
      }
    ...
    delete(pid):Observable<IProduct>
    {
      const httpOptions =  new HttpHeaders({
       ...
       return this.h.delete<IProduct>(`${environment.DataURl2}/product/${pid}`)
      }
